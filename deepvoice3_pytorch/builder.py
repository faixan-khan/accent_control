...
def nyanko(n_vocab, embed_dim=128, mel_dim=80, linear_dim=513, r=1,
           ...
           key_projection=False,
           value_projection=False,
           faces=None, video_lengths=None,
           ):
    from deepvoice3_pytorch.nyanko import Encoder, Decoder, Converter, Face_Encoder, Face_Decoder
    ...
    face_encoder = Face_Encoder( faces, video_lengths) 
    ...
    seq2seq = AttentionSeq2Seq(encoder, decoder, face_encoder, face_decoder)
