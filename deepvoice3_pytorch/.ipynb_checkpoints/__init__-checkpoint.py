...
class MultiSpeakerTTSModel(nn.Module):
    ...
    def forward(self, text_sequences, mel_targets=None, speaker_ids=None,
                text_positions=None, frame_positions=None, input_lengths=None, faces=None, video_lengths=None):
        ...
        mel_outputs, alignments, done, decoder_states, alignments_f = self.seq2seq(
            ...
            text_positions, frame_positions, input_lengths, video_lengths, faces)
...
class AttentionSeq2Seq(nn.Module):
    ...
    def forward(self, text_sequences, mel_targets=None, speaker_embed=None,
                text_positions=None, frame_positions=None, input_lengths=None,video_lengths=None, faces=None):
        # (B, T, text_embed_dim)
        encoder_outputs = self.encoder(
            text_sequences, lengths=input_lengths, speaker_embed=speaker_embed)

        face_encoder_outputs =  self.face_encoder( faces, video_lengths)
